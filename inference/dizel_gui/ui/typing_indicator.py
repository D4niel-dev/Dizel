...
from dizel_gui.theme.colors import BUBBLE_ASST, TEXT_SECONDARY, TYPING_DOT, resolve, ACCENT, ACCENT_LIGHT
from dizel_gui.theme.fonts import TYPING_TEXT
from dizel_gui.logic.config_manager import ConfigManager
from dizel_gui.theme.stylesheets import get_frame_style
