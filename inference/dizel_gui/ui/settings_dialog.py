...
from dizel_gui.theme.fonts import LOGO, BTN_LABEL, LABEL, LABEL_SM
from dizel_gui.logic.config_manager import ConfigManager
from dizel_gui.theme.stylesheets import get_button_style, get_frame_style, get_scrollbar_style
...
class SettingsDialog(QDialog):
    ...
    def _open_custom_provider_dialog(self):
        ...
        if api_cfg.get("provider") == "custom":
            ...
            from dizel_gui.logic.config_manager import decrypt_key
        ...
        if dlg.exec():
            ...
            from dizel_gui.logic.config_manager import encrypt_key
    ...
    def _open_api_config(self):
        ...
        from dizel_gui.logic.providers import get_provider
        provider = get_provider(slug)

        from dizel_gui.ui.api_key_dialog import APIKeyDialog
