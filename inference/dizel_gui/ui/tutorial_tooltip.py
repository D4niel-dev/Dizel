...
from dizel_gui.theme.colors import resolve, BG_INPUT, BORDER, ACCENT, TEXT_PRIMARY, TEXT_DIM, SEND_BTN, SEND_BTN_HOVER
from dizel_gui.theme.fonts import LABEL_SM, NAV_ITEM, LABEL_DIM
from dizel_gui.theme.stylesheets import get_frame_style, get_button_style
from dizel_gui.utils.icons import get_icon
from dizel_gui.logic.tutorial_manager import TutorialStep
