...
from dizel_gui.theme.colors import (BG_INPUT, BG_INPUT_FIELD, TEXT_PRIMARY, TEXT_DIM, 
                                   ACCENT, resolve, WELCOME_CARD_HOVER, BG_ROOT, BORDER, BORDER_FOCUS)
from dizel_gui.theme.fonts import CARD_TITLE, INPUT_TEXT, LABEL_SM, LABEL_DIM
from dizel_gui.theme.stylesheets import get_button_style, get_frame_style
from dizel_gui.ui.waveform_widget import WaveformWidget
