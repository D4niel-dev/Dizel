...
from dizel_gui.ui.chat_window        import ChatWindow
from dizel_gui.ui.sidebar            import Sidebar
from dizel_gui.ui.secondary_sidebar  import SecondarySidebar
from dizel_gui.ui.input_panel        import InputPanel
from dizel_gui.ui.settings_dialog    import SettingsDialog
from dizel_gui.ui.profile_dialog     import ProfileDialog
from dizel_gui.ui.command_palette    import CommandPalette
from dizel_gui.ui.nova_overlay       import NovaOverlay
from dizel_gui.logic.nova_worker     import NovaWorker
from dizel_gui.logic.chat_manager    import ChatManager
from dizel_gui.logic.history_manager import (
...
class DizelApp(QMainWindow):
    ...
    def _setup_tutorial(self):
        from dizel_gui.logic.tutorial_manager import TutorialManager
        
        self._tut_mgr = TutorialManager()
        if not self._tut_mgr.should_show():
            return
            
        from dizel_gui.ui.tutorial_overlay import TutorialOverlay
        from dizel_gui.ui.tutorial_tooltip import TutorialTooltip
    ...
    def _on_edit_message(self, bubble, new_text):
        ...
        for i in range(layout.count()):
            ...
            from dizel_gui.ui.message_bubble import MessageBubble
