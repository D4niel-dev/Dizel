...
from inference.cmd_tui.rendering.stream_buffer import StreamBuffer
from inference.cmd_tui.rendering.tool_block import ToolBlock
from inference.cmd_tui.rendering.status_block import StatusBlock
from inference.cmd_tui.bridge.chat_bridge import ChatBridge
from inference.cmd_tui.bridge.tool_bridge import ToolBridge
from inference.cmd_tui.rendering.empty_state import EmptyStateBlock
...
class WorkspacePanel(VerticalScroll):
    ...
    def on_done(self, event: ChatBridge.GenerationDone) -> None:
        ...
        try:
            ...
            artifact_panel = self.app.query_one(ArtifactPanel)
            artifact_panel.update_artifacts(event.full_text)
        except Exception:
            pass
