...
class NearDeduplicator:
    ...
    def __init__(self, n: int = 5, threshold: float = 0.8, max_compare: int = 1000):
        self.n = n
        self.threshold = threshold
        self.seen_shingles = deque(maxlen=max_compare)
    ...
    def is_near_duplicate(self, text: str) -> bool:
        ...
        for prev in self.seen_shingles:
            if not prev:
                continue
