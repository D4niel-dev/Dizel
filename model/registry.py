...
register_model(ModelEntry(
    ...
    description="Original 80M parameter model with learned positional embeddings.",
    version="v1.1.0",
    param_count="~80M",
    is_default=False,
    status="deprecated",
...
register_model(ModelEntry(
    ...
    description="284M parameter model with RoPE, 4K context, and weighted dataset mixing.",
    version="v1.2.0",
    param_count="~284M",
    is_default=True,
    status="available",
...
register_model(ModelEntry(
    ...
    description="~110M conversational sister model. Warm, talkative, encouraging personality.",
    author="D4niel-dev",
    version="v1.0.0",
    param_count="~110M",
    is_default=False,
